...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~crm-clientes-clientes-module-ngfactory~crm-clientes-edit-edit-module-ngfactory~crm-delivery-~7d4b9e82"], {
  /***/
    ...
    function () {
      ...
      _createClass(ApisService, [{
        ...
        value: function generatePdfInvoiceDraft(invoices, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this42.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].viewdraft, invoices, opt).toPromise().then(function (invoice) {
              resolve(invoice);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getExcelPrealertDraft(prealert, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this43.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].getXlsPrealert, prealert, opt).toPromise().then(function (prealert) {
              resolve(prealert);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getstatusprealert(token) {
          ...
          return new Promise(function (resolve, reject) {
            _this44.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].getstatusprealert, opt).toPromise().then(function (prealert) {
              resolve(prealert);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function addstatusprealert(status, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this45.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].addstatusprealert, status, opt).toPromise().then(function (prealert) {
              resolve(prealert);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function updatestatusprealert(status, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this46.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].updatestatusprealert, status, opt).toPromise().then(function (prealert) {
              resolve(prealert);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function deletestatusprealert(status, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this47.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].deletestatusprealert, status, opt).toPromise().then(function (prealert) {
              resolve(prealert);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getTemplates(token) {
          ...
          return new Promise(function (resolve, reject) {
            _this48.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].templates, opt).toPromise().then(function (template) {
              resolve(template);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function addTemplateHead(headTemplate, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this49.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].addtemplateshead, headTemplate, opt).toPromise().then(function (template) {
              resolve(template);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function addTemplateDetaill(detailTemplate, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this50.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].addtemplatesdetaill, detailTemplate, opt).toPromise().then(function (template) {
              resolve(template);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function deleteTemplate(idTemplate, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this51.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].deletetemplate + idTemplate, null, opt).toPromise().then(function (template) {
              resolve(template);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function deleteTemplateDetalle(idDetalle, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this52.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].deletetemplatedetalle + idDetalle, null, opt).toPromise().then(function (template) {
              resolve(template);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function updateTemplateDetalle(detaill, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this53.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].updatetemplatedetalle, detaill, opt).toPromise().then(function (template) {
              resolve(template);
            }).catch(function (error) {
              reject(error);
            });
...
//# sourceMappingURL=default~crm-clientes-clientes-module-ngfactory~crm-clientes-edit-edit-module-ngfactory~crm-delivery-~7d4b9e82-es5.js.map