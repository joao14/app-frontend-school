    ...
    function () {
      ...
      _createClass(ApisService, [{
        ...
        value: function getObjectbyNameComplete(type, name, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this30.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].searchtypeComplete + type, json, opt).toPromise().then(function (invoice) {
              resolve(invoice);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getObjectbyName(type, name, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this31.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].searchtype + type, json, opt).toPromise().then(function (invoice) {
              resolve(invoice);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getsales(dateIni, dateFin, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this32.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].getsales + dateIni + '/' + dateFin, opt).toPromise().then(function (sales) {
              resolve(sales);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getInvoicesbyClient(idClient, dateIni, dateFin, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this33.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].getinvoicesbyclient + idClient + '/' + dateIni + '/' + dateFin, opt).toPromise().then(function (sales) {
              resolve(sales);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getBalanceGeneralbyClient(idClient, dateIni, dateFin, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this34.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].getbalancegenral + idClient + '/' + dateIni + '/' + dateFin, opt).toPromise().then(function (sales) {
              resolve(sales);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getMarcbyName(idClient, name_, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this35.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].getmarcsbyname + idClient, json, opt).toPromise().then(function (marc) {
              resolve(marc);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getPrealertActive(token) {
          ...
          return new Promise(function (resolve, reject) {
            _this36.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].getprealertactive, opt).toPromise().then(function (prealert) {
              resolve(prealert);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getPrealertActivebyClient(idClient, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this37.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].getprealertactivebyClient + idClient, opt).toPromise().then(function (prealert) {
              resolve(prealert);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function sendEmail(email, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this38.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].sendEmail, email, opt).toPromise().then(function (email) {
              resolve(email);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getinvoicesdraft(token) {
          ...
          return new Promise(function (resolve, reject) {
            _this39.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].invoicesdrafts, opt).toPromise().then(function (invoice) {
              resolve(invoice);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getcharts(token) {
          ...
          return new Promise(function (resolve, reject) {
            _this40.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].charts, opt).toPromise().then(function (invoice) {
              resolve(invoice);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getchartsbyclient(idClient, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this41.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].chartsbyclient + idClient, opt).toPromise().then(function (invoice) {
              resolve(invoice);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getprealertsdraft(token) {
          ...
          return new Promise(function (resolve, reject) {
            _this42.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].prealertdrafts, opt).toPromise().then(function (prealert) {
              resolve(prealert);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function generatePdfInvoiceDraft(invoices, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this43.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].viewdraft, invoices, opt).toPromise().then(function (invoice) {
              resolve(invoice);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getExcelPrealertDraft(prealert, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this44.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].getXlsPrealert, prealert, opt).toPromise().then(function (prealert) {
              resolve(prealert);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getstatusprealert(token) {
          ...
          return new Promise(function (resolve, reject) {
            _this45.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].getstatusprealert, opt).toPromise().then(function (prealert) {
              resolve(prealert);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function addstatusprealert(status, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this46.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].addstatusprealert, status, opt).toPromise().then(function (prealert) {
              resolve(prealert);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function updatestatusprealert(status, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this47.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].updatestatusprealert, status, opt).toPromise().then(function (prealert) {
              resolve(prealert);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function deletestatusprealert(status, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this48.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].deletestatusprealert, status, opt).toPromise().then(function (prealert) {
              resolve(prealert);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getTemplates(token) {
          ...
          return new Promise(function (resolve, reject) {
            _this49.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].templates, opt).toPromise().then(function (template) {
              resolve(template);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function addTemplateHead(headTemplate, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this50.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].addtemplateshead, headTemplate, opt).toPromise().then(function (template) {
              resolve(template);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function addTemplateDetaill(detailTemplate, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this51.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].addtemplatesdetaill, detailTemplate, opt).toPromise().then(function (template) {
              resolve(template);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function deleteTemplate(idTemplate, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this52.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].deletetemplate + idTemplate, null, opt).toPromise().then(function (template) {
              resolve(template);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function deleteTemplateDetalle(idDetalle, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this53.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].deletetemplatedetalle + idDetalle, null, opt).toPromise().then(function (template) {
              resolve(template);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function updateTemplateDetalle(detaill, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this54.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].updatetemplatedetalle, detaill, opt).toPromise().then(function (template) {
              resolve(template);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function pedidos(token) {
          ...
          return new Promise(function (resolve, reject) {
            _this55.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].pedidos, opt).toPromise().then(function (pedidos) {
              resolve(pedidos);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getInformationAllOrders(dateIni, dateFin, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this56.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].historicordersall + '/' + dateIni + '/' + dateFin, opt).toPromise().then(function (pedidos) {
              resolve(pedidos);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function getInformationAllOrdersbyClient(clieId, estado, dateIni, dateFin, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this57.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].historicordersbyclient + clieId + '/' + estado + '/' + dateIni + '/' + dateFin, opt).toPromise().then(function (pedidos) {
              resolve(pedidos);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function pedidosbyclient(clieId, estado, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this58.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].pedidobyclient + clieId + '/' + estado + '/20210414000000/20210414000000', opt).toPromise().then(function (pedidos) {
              resolve(pedidos);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function addpedido(pedido, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this59.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].pedidoregister, pedido, opt).toPromise().then(function (pedido) {
              resolve(pedido);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function updatedatesorder(order, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this60.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].updatedatesorder, order, opt).toPromise().then(function (order) {
              resolve(order);
            }).catch(function (error) {
              reject(error);
            });
        ...
        value: function sendnotification(pedido, token) {
          ...
          return new Promise(function (resolve, reject) {
            _this61.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].notificationprealert, pedido, opt).toPromise().then(function (notification) {
...
//# sourceMappingURL=default~crm-clientes-clientes-module-ngfactory~crm-clientes-edit-edit-module-ngfactory~crm-delivery-~e453b710-es5.js.map