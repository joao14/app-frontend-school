      ...
      _createClass(PrealertaComponent, [{
        ...
        value: function viewdraft(draft) {
          ...
          regeneratorRuntime.mark(function _callee15() {
            ...
            }, _callee15, this, [[4, 46, 49, 52], [9, 36, 39, 42]]);
          }));
        }
      }, {
        key: "viewxlsx",
        value: function viewxlsx() {
          ...
          this.items.forEach(function (data) {
            detail.push({
              line: contador,
              shippingdate: _this16.getFormatDate(new Date(data.fecha)),
              clieId: data.cliente.entiId,
              fincapropia: data.fincapropia == 'N' ? 'N' : 'S',
              farmId: data.finca.entiId,
              marcId: data.marca.marcId,
        ...
        value: function edit(draft) {
          ...
          regeneratorRuntime.mark(function _callee16() {
            var _iterator3, _step3, clie, _iterator4, _step4, item, cliente, finca, marca, rosamistica, carga, temp;
              ...
              while (1) {
                switch (_context16.prev = _context16.next) {
                  case 0:
                    ...
                    this.utilService.isLoading.next(true);
                    this.total = 0;
                    _iterator3 = _createForOfIteratorHelper(draft.clients);
                    _context16.prev = 9;
                  ...
                  case 11:
                    ...
                    clie = _step3.value;
                    _iterator4 = _createForOfIteratorHelper(clie.items);
                    _context16.prev = 14;
                  ...
                  case 20:
                    cliente = _context16.sent;
                    _context16.next = 23;
                    return this.getFincabyName(item.farm);

                  case 23:
                    finca = _context16.sent;
                    _context16.next = 26;
                    return this.getMarcbyName(clie.info.clieId, item.mark);

                  case 26:
                    marca = _context16.sent;
                    _context16.next = 29;
                    return this.getFlowerbyName(item.flower);

                  case 29:
                    rosamistica = _context16.sent;
                    _context16.next = 32;
                    return this.getEmpresaCargabyName(item.cargname);

                  case 32:
                    carga = _context16.sent;
                    _context16.next = 35;
                    return this.getStatus(item.status);
            ...
            }, _callee16, this, [[9, 53, 56, 59], [14, 43, 46, 49]]);
          }));
        }
      }, {
        key: "saveeraser",
